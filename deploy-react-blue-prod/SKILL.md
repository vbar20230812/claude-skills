...
**Announce at start:** "Deploying AssetFlow React user app to BLUE production."
...
```bash
cd C:/Users/victo/Projects/assetsflow && bash scripts/deploy-react.sh prod-blue
```
...
```bash
browser-harness -c '
new_tab("https://assetsflow-blue-work.web.app")
wait_for_load()
print(page_info())
capture_screenshot("C:/tmp/blue-prod-deploy-verify.png")
'
```
...
```bash
curl -sL --ssl-no-revoke -o /dev/null -w "%{http_code}" https://assetsflow-blue-work.web.app
```
...
```
═══════════════════════════════════════════════════════════
  ✅ REACT APP BLUE PROD DEPLOYMENT COMPLETE
═══════════════════════════════════════════════════════════

URL: https://assetsflow-blue-work.web.app
